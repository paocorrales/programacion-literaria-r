...
```{r lectura}
pinguinos <- read_csv("https://raw.githubusercontent.com/yabellini/deHojasDeCalculoAR/main/datos/pinguinos.csv")
...
```{r pico, fig.cap="Relación entre el largo y el alto del pico en mm."}
pinguinos %>% 
...
```{r masa, fig.cap="Distribución de la masa corporal de los pinggüinos según su sexo."}
pinguinos %>% 
  filter(especie == "Papúa") %>% 
