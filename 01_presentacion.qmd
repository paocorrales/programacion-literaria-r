...
-   1970: Escribir programas en lenguaje humano.
    Las herramientas de programación se encargan de separar el programa (para compilar y ejecutar) de su documentación.
