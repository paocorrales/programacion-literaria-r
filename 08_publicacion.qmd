...
Podés revisar un ejemplo de una web a partir de un único archivo en [https://01-webs-rmarkdown.netlify.app/](https://01-webs-rmarkdown.netlify.app/)
...
Tal vez el contenido que querés mostrar es más complejo y poner todo en un único .Rmd no termina de funcionar. RMarkdown y Quarto también permiten generar una web con estructura compleja (una barra de navegación con botones y menues entre otras maravillas) a partir de un archivo de configuración y todos los .rmd o .qmd que necesites. El ejemplo de una web de este estilo se encuenta en:
...
El resto se parece mucho a lo que ya vimos. Necesitaremos un archivo index.html que será nuestra página de inicio y luego podremos agregar tantas secciones como querramos. 


Podés revisar un ejemplo de una web construida a partir de varios archivos en: [https://02-webs-rmarkdown.netlify.app/](https://02-webs-rmarkdown.netlify.app/)
